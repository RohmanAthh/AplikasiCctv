...
export default function Home() {
  return (
    <div className="bg-gradient-to-b from-white via-blue-50 to-white min-h-[90vh] flex flex-col items-center justify-center">
      ...
      <img src="/logo192.png" alt="CCTV" className="w-40 md:w-64 h-auto mt-16 drop-shadow-xl" />
    </div>
  );
}